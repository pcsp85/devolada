...
<? if($_SESSION["mailer"]=="activo"){ ?>
     <h2>Bienvenido</h2>
      <p>Este sistema esta diseñado para el envio de correos masivos, aqui podrás generar y administrar listas de distribución, asi como la administracion de los destinatarios.</p>
<? }else{ ?>
   <h2>Autenticaci&oacute;n</h2>
   <p>Para usar este sistema debes contar con usuario y contraseña</p>
   <form name="is" method="post" action="sess.php">
   <table align="center" width="300">
   <tr><td colspan="2"><?=$_SESSION["mailer"]?></td></tr>
   <tr><th>Usuario:</th><td><input type="text" name="user"></td></tr>
   <tr><th>Contraseña:</th><td><input type="password" name="pass"></td></tr>
   <tr><td colspan="2" align="center"><input type="submit" value="Iniciar Sesión">
   </table>
   </form>
<? } ?>
    </section>
